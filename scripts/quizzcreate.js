let quizzTitle
let quizzImage
let quizzQuestionNumber
let quizzLevelNumber

loadQuizzStart();

function loadQuizzStart() {
  document.querySelector('main').innerHTML = ` <div class="quizz-start">
  ...
  <div class="basic-informations">
    ...
    <p class="alert quizz-image hide">Deve ser uma URL válida</p>
